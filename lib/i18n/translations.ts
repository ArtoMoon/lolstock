...
export const translations = {
  tr: {
    ...
    added_label: 'Eklendi',
    show_username: 'Göster',
    hide_username: 'Gizle',
    not_set: 'Belirtilmedi',
    edit_label: 'Düzenle',
    notes_title: 'Notlar',
    notes_placeholder: 'Bu hesap hakkında not ekle...',
    recent_matches_title: 'Son {count} Maç (Kayıtlı)',
    avg_kda: 'Ortalama KDA',
    fetch_matches: "Maçları Riot'tan Çek",
    update_matches: 'Son Maçları Güncelle',
    fetching_matches: 'Maçlar Çekiliyor...',
    no_matches_title: 'Bu hesapta oynanmış maç bulunamadı',
    no_matches_desc: 'Riot API sorgulandı ancak bu hesapta son zamanlarda oynanmış karşılaşma bulunmuyor veya hesap yeni açılmış.',
    ...
    duration: 'Süre',
    game_mode: 'Oyun Modu',
    status_select_label: 'Hesap Durumu',
  ...
  en: {
    ...
    edit_label: 'Edit',
    notes_title: 'Notes',
    notes_placeholder: 'Add personal notes about this account...',
    recent_matches_title: 'Last {count} Matches',
    avg_kda: 'Average KDA',
    fetch_matches: 'Fetch Matches from Riot',
    update_matches: 'Update Matches',
    fetching_matches: 'Fetching matches...',
    no_matches_title: 'No match history recorded',
    no_matches_desc: 'Riot API was queried but no recent matches were found or this account is newly created.',
    ...
    duration: 'Duration',
    game_mode: 'Game Mode',
    status_select_label: 'Account Status',
